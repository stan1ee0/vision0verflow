...
const HomeHeaderTopContainer = styled.div`
...
const HomeHeaderItemLeftDiv = styled.div`
...
const HomeHeaderItemLeftLink = styled(Link)`
...
const HomeHeaderItemRightDiv = styled.div`
  height: 100% !important;
  position: relative !important;
  padding: 24px !important;
...
const HomeHeaderItemRightLink = styled(Link)`
  font-family: 'Source Sans Pro Bold',sans-serif;
  font-weight: 400;
  max-width: calc(97.2307692rem / 12 * 2) !important;
  width: 100% !important;
...
const HomeHeaderSpan = styled.span`
  ...
  margin-left: auto !important;
  margin-right: auto !important;
  background-color: hsl(210,8%,45%); !important;
  border-radius: 1000px !important;
`;

const HomeHeaderBottomContainer = styled.div`
  max-width: calc(97.2307692rem / 12 * 9) !important;
  display: flex !important;
...
const HomeHeaderItemBottomDiv = styled.div`
  font-family: 'Roboto Slab Bold',serif;
  font-weight: 700;
              ...
              <HomeHeaderTopContainer>
                <HomeHeaderItemContainer>
                  <HomeHeaderItemLeftDiv>
                    <LeftSvg width="48" height="48" viewBox="0 0 48 48">
                    ...
                    <HomeHeaderItemLeftLink className='button'>Join the community</HomeHeaderItemLeftLink>
                  </HomeHeaderItemLeftDiv>
                </HomeHeaderItemContainer>
                <HomeHeaderItemContainer>
                  <HomeHeaderItemRightDiv>
                    <RightSvg width="48" height="48" viewBox="0 0 48 48">
                    ...
                    <HomeHeaderItemRightLink className='button'>Discover Teams</HomeHeaderItemRightLink>
                  </HomeHeaderItemRightDiv>
                </HomeHeaderItemContainer>
              </HomeHeaderTopContainer>
              <HomeHeaderH1>
                ...
                <br />
                {' '}tab open to Vision 0verflow{' '}
              </HomeHeaderH1>
              <HomeHeaderSpan></HomeHeaderSpan>
              <HomeHeaderBottomContainer>
                <HomeHeaderItemContainer>
                  <HomeHeaderItemBottomDiv>
                    Email: vision@verflow.org
                    <br />
                    Password: Vision0verflow
                  </HomeHeaderItemBottomDiv>
                </HomeHeaderItemContainer>
              </HomeHeaderBottomContainer>
            </HomeHeaderInnerContainer>
